...
projection into Lydia' display, approval bridging, transcript projection into
...
"codex_app_server"`. Lydia' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("LYDIA_KANBAN_TASK"):
            kanban_db = spawn_env.get("LYDIA_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "LYDIA_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("LYDIA_HOME", os.path.expanduser("~/.lydia")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "lydia",
        client_title: str = "Lydia Agent",
