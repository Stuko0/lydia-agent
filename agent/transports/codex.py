...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Lydia's web-provider config and
        ...
        # native search engine for xAI sessions instead of Lydia's
        # configured web provider (Tavily/etc.), and those results bypass
        # Lydia's tool-trace / citation plumbing (they arrive baked into the
