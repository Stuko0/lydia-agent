"""AWS Bedrock Converse API adapter for Lydia Agent.
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install Lydia with Bedrock support: pip install -e '.[bedrock]'"
        )
    # converse() / converse_stream() were added in boto3 1.34.59.
    # When Lydia is installed editable into system Python, the system boto3
