"""Tests for `lydia curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import lydia_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated LYDIA_HOME with real agent-created skills on disk."""
    home = tmp_path / ".lydia"
    skills = home / "skills"
    ...
    from lydia_cli import curator as curator_cli
