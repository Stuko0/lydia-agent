"""Tests for the interactive session browser (`lydia sessions browse`).
...
from lydia_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """lydia sessions browse should be parseable."""
