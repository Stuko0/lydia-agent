...
The main() function in lydia_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `lydia -c model`
...
def _build_parser():
    """Build a minimal replica of the lydia top-level parser."""
