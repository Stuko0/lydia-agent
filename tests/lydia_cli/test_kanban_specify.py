"""Tests for the specifier module + `lydia kanban specify` CLI surface.
...
from lydia_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `lydia kanban …` argparse surface directly."""
