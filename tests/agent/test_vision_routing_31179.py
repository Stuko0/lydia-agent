...
def isolated_home(monkeypatch):
    """Temp LYDIA_HOME with config + clean credential env vars."""
    test_home = tempfile.mkdtemp(prefix="lydia_test_31179_")
    lydia_home = os.path.join(test_home, ".lydia")
...
def _fresh_modules():
    """Drop cached lydia modules so each test reloads against current env."""
