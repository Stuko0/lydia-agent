...
to a generic "Your API key was rejected... run lydia setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "lydia setup".
    assert "lydia portal" in source
