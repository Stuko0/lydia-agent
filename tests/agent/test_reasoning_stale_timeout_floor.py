...
thinking phase.  Lydia's default cloud-stream stale detector
(``LYDIA_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``LYDIA_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
