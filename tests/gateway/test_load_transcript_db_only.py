...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.lydia/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at lydia_state import time, before pytest's LYDIA_HOME monkeypatch
    fires — the autouse fixture's LYDIA_HOME override doesn't help here.)
    """
    import lydia_state
