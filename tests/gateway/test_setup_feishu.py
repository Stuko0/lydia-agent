"""Tests for _setup_feishu() in lydia_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("lydia_cli.config.save_env_value", side_effect=mock_save), \
         patch("lydia_cli.config.get_env_value", side_effect=mock_get), \
         patch("lydia_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("lydia_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("lydia_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("lydia_cli.cli_output.print_header"), \
         patch("lydia_cli.cli_output.print_info"), \
         patch("lydia_cli.cli_output.print_success"), \
         patch("lydia_cli.cli_output.print_warning"), \
         patch("lydia_cli.cli_output.print_error"), \
