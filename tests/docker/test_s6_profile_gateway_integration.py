...
The unit tests in tests/lydia_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned lydia-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/lydia")
from lydia_cli.service_manager import S6ServiceManager
