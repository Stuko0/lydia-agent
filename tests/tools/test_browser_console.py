...
class TestBrowserConsoleToolsetWiring:
    ...
    def test_in_lydia_core_tools(self):
        from toolsets import _LYDIA_CORE_TOOLS
        assert "browser_console" in _LYDIA_CORE_TOOLS
...
class TestBrowserVisionConfig:
    ...
    def test_browser_vision_uses_configured_temperature_and_timeout(self, tmp_path):
        ...
        with (
            patch("lydia_constants.get_lydia_dir", return_value=shots_dir),
            ...
            patch("tools.browser_tool._get_vision_model", return_value="test-model"),
            patch("lydia_cli.config.load_config", return_value={"auxiliary": {"vision": {"temperature": 1, "timeout": 45}}}),
