...
def test_env_scrub_lydia_allowlist_and_secret_blocks():
    ...
    for kept in ("LYDIA_HOME", "LYDIA_PROFILE", "LYDIA_CONFIG", "LYDIA_ENV", "PATH"):
...
def test_env_scrub_logs_dropped_lydia_vars(caplog):
    ...
    env = {
        "LYDIA_HOME": "/h",          # allowlisted → kept, not logged
    ...
    assert "LYDIA_HOME" in out and "PATH" in out
