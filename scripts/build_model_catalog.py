#!/usr/bin/env python3
"""Build the Lydia Model Catalog — a centralized JSON manifest of curated models.
...
Lydia CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Lydia release.
...
# Ensure LYDIA_HOME is set for imports that touch it at module level.
os.environ.setdefault("LYDIA_HOME", os.path.join(os.path.expanduser("~"), ".lydia"))

from lydia_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "lydia-agent repo",
            "docs": "https://lydia-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
