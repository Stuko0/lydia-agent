#!/usr/bin/env python3
"""Build the Lydia Skills Index — a centralized JSON catalog of all skills.
...
`lydia skills search/install` can use it without hitting the GitHub API.
...
# Ensure LYDIA_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Lydia Skills Index...", flush=True)
