...
```bash
python3 -m pyfiglet "LYDIA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=LYDIA&font=Slant" | boxes -d stone
```
