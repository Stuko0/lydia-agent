#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Lydia docs site.
...
Both publish at:
  https://lydia-agent.nousresearch.com/docs/llms.txt
  https://lydia-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://lydia-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Lydia as a Python Library", None),
        ("guides/use-mcp-with-lydia", "Use MCP with Lydia", None),
        ("guides/use-voice-mode-with-lydia", "Use Voice Mode with Lydia", None),
        ("guides/use-soul-with-lydia", "Use SOUL.md with Lydia", None),
        ("guides/build-a-lydia-plugin", "Build a Lydia Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Lydia"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "lydia-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/lydia-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Lydia Agent — Full Documentation\n",
        (
            "This file is the entire Lydia Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Lydia, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://lydia-agent.nousresearch.com/docs\n",
        "Short index: https://lydia-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
