...
sidebar_position: 7
title: "Email"
description: "Set up Lydia Agent as an email assistant via IMAP/SMTP"
---
...
|---|---|---|
| Let people email the Lydia Agent and receive replies | Email gateway adapter on this page | None beyond an IMAP/SMTP email account |
...
- **A dedicated email account** for your Lydia Agent (don't use your personal email)
