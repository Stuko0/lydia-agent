...
:::info
The `browser` toolset must be included in your config's `toolsets` list or enabled via `lydia config set toolsets '["hermes-cli", "browser"]'`.
:::
