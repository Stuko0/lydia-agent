...
| Related skills | `native-mcp`, [`ascii-video`](/docs/user-guide/skills/bundled/creative/creative-ascii-video), [`manim-video`](/docs/user-guide/skills/bundled/creative/creative-manim-video), `lydia-video` |
...
3. Add `twozero_td` MCP server to Lydia config (if missing)
...
3. **Restart Lydia session** to pick up the new MCP server
