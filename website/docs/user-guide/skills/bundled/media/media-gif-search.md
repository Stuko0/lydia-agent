...
Set your Tenor API key in your environment (add to `${LYDIA_HOME:-~/.lydia}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/NousResearch/lydia-agent/blob/main/skills/media/gif-search/url)`
