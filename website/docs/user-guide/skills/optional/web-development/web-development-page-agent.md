...
- User wants **Lydia itself to drive a browser** → use Lydia' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
