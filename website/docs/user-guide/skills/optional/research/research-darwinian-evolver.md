...
| | |
|---|---|
| Source | Optional — install with `lydia skills install official/research/darwinian-evolver` |
| Path | `optional-skills/research/darwinian-evolver` |
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Lydia Agent |
| License | MIT |
...
import upstream classes into Lydia itself.
...
Open `~/.lydia/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Lydia core.
   Custom driver scripts under `~/.lydia/skills/...` are user-side and fine.
