...
| | |
|---|---|
| Source | Optional — install with `lydia skills install official/research/qmd` |
...
Lydia Agent via the native MCP client. This is the preferred
...
Then configure Lydia Agent to connect via HTTP:
