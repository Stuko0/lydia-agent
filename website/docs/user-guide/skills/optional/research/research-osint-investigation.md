...
| | |
|---|---|
| Source | Optional — install with `lydia skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Lydia Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $LYDIA_OSINT_CACHE/icij/ (default: ~/.cache/lydia-osint/icij/).
...
# Set LYDIA_OSINT_UA=your-app/1.0 (your@email) to identify yourself
