...
| | |
|---|---|
| Source | Optional — install with `lydia skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Lydia Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${LYDIA_HOME:-~/.lydia}/.env`:
