...
| | |
|---|---|
| Source | Optional — install with `lydia skills install official/health/neuroskill-bci` |
...
Connect Lydia to a running [NeuroSkill](https://neuroskill.com/) instance to read
