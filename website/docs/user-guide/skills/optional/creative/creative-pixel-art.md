...
| | |
|---|---|
| Source | Optional — install with `lydia skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.lydia/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.lydia/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Lydia installs package this)
