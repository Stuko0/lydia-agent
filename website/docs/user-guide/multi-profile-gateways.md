...
If you only run one Lydia Agent, you don't need this page — see
[Profiles](./profiles.md) for the basics.

## When to use this

You want this setup when you have two or more Lydia Agents that should all
...
```bash
lydia config set model.model anthropic/claude-sonnet-4    # default profile
