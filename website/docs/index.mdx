...
slug: /
sidebar_position: 0
title: "Lydia Agent Documentation"
description: "The self-improving AI agent built by Stuko. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Stuko](https://stuko.dev). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
>
  ...
  <a
    href="https://github.com/Stuko/lydia-agent"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
      border: "1px solid rgba(255,215,0,0.2)",
...
To easily install the command-line and desktop applications, [download the Lydia Desktop installer](https://lydia-agent.stuko.dev/) from our website and run it.
...
After installing, run `lydia setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Lydia safely  |
| 🧭 **[Use MCP with Lydia](/guides/use-mcp-with-lydia)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Lydia](/guides/use-voice-mode-with-lydia)** | Hands-on setup and usage patterns for Lydia voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Lydia' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Lydia                              |
...
- **Built by model trainers** — Created by [Stuko](https://stuko.dev), the lab behind Lydia, Nomos, and Psyche. Works with [Nous Portal](https://portal.stuko.dev), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Stuko](https://stuko.dev) — the lab behind Lydia, Nomos, and Psyche models
