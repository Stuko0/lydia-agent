...
def _profile_user_agent() -> str:
    """Return a ``lydia-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from lydia_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"lydia-cli/{_ver}"
    except Exception:
        return "lydia-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # lydia-cli UA so the catalog endpoint is reachable.
