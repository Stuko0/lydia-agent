    ...
    for config_path in configs:
        try:
            ...
            for line in content.split('\n'):
                ...
                if '# Lydia Agent' in line or '# hermes-agent' in line:
                    skip_next = True
                    continue
...
def run_gui_uninstall(args):
    ...
    if agent_is_installed(hermes_home):
        ...
        print(f"  • The Lydia Agent at {hermes_home / 'hermes-agent'}")
    ...
    print(color("└─────────────────────────────────────────────────────────┘", Colors.GREEN, Colors.BOLD))
    print()
    print("The Lydia Agent is still installed. Run 'hermes' to use the CLI,")
