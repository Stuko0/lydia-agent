...
export interface PetInfo {
  ...
  // the Lydia "run" activity state uses the in-place running row).
 ...
 * LYDIA_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'lydia.desktop.pet-roam.v1'
