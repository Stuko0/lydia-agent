 ...
 * app's bounds and stays visible while Lydia is minimized. That window carries
...
const OVERLAY_ACTIVE_KEY = 'lydia.desktop.pet-overlay-active.v1'
const OVERLAY_BOUNDS_KEY = 'lydia.desktop.pet-overlay-bounds.v1'
