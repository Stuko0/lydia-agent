...
import type { SessionInfo, UsageStats } from '@/types/lydia'

type Updater<T> = T | ((current: T) => T)

const WORKSPACE_CWD_KEY = 'lydia.desktop.workspace-cwd'
...
const COMPOSER_MODEL_KEY = 'lydia.desktop.composer.model'
const COMPOSER_PROVIDER_KEY = 'lydia.desktop.composer.provider'
const COMPOSER_EFFORT_KEY = 'lydia.desktop.composer.reasoning-effort'
const COMPOSER_FAST_KEY = 'lydia.desktop.composer.fast'
...
const LAST_SESSION_KEY = 'lydia.desktop.lastSessionId'
