...
import { getProfiles, setApiRequestProfile } from '@/lydia'
...
import type { ProfileInfo } from '@/types/lydia'
...
// /api/profiles/active `current`). "default" is the root ~/.lydia. This is the
...
const PROFILE_ORDER_STORAGE_KEY = 'lydia.desktop.profileOrder'
...
const PROFILE_COLORS_STORAGE_KEY = 'lydia.desktop.profileColors'
...
const SHOW_ALL_PROFILES_STORAGE_KEY = 'lydia.desktop.showAllProfiles'
...
// Switch to the default (root ~/.lydia) profile — bound to ⌘1.
