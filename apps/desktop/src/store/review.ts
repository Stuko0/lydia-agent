...
//
// Scope is always "uncommitted" — Lydia' flow is agent edits you review BEFORE
...
const OPEN_KEY = 'lydia.desktop.reviewOpen'
const COMMIT_DEFAULT_KEY = 'lydia.desktop.reviewCommitDefault'
const TREE_MODE_KEY = 'lydia.desktop.reviewTreeMode'
const SELECTED_KEY = 'lydia.desktop.reviewSelectedPath'
