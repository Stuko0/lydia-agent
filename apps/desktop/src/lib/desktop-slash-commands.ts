...
/** Why a known Lydia command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Lydia profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show Lydia Agent version', surface: exec() },
 ...
 * Lydia' built-in slash commands — i.e. skill commands (`/gif-search`,
