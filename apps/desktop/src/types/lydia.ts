...
export interface OAuthProvider {
   ...
   *  embedded terminal. Null when Lydia doesn't know how to remove it. */
 ...
 *  not Lydia); elsewhere, driver health from `cua-driver doctor`. `null`
...
/** Shape of `GET /api/lydia/update/check` — the backend's own update state.
