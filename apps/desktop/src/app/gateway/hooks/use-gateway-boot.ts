import { isGatewayReauthRequired, resolveGatewayWsUrl } from '@lydia/shared'
import { useEffect, useRef } from 'react'

import type { LydiaConnection } from '@/global'
import { LydiaGateway } from '@/lydia'
...
import type { RpcEvent } from '@/types/lydia'
...
export function useGatewayBoot({
  ...
  useEffect(() => {
    ...
    // composer stayed disabled forever on "Starting Lydia...". Once the
    ...
    const attemptReconnect = async () => {
      ...
      try {
        ...
        // "Starting Lydia…". The probe is a no-op for a healthy or local backend.
        ...
        // as an opaque "Could not connect to Lydia gateway". resolveGatewayWsUrl
