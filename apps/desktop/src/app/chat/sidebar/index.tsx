...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/lydia'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('lydia:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('lydia:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Lydia to
