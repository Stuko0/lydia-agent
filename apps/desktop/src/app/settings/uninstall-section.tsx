...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove this desktop app. The Lydia Agent, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove the app and the Lydia Agent, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the Chat GUI and the Lydia Agent (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — the Chat GUI, the Lydia Agent, and all of your config, chats, secrets, and logs',
