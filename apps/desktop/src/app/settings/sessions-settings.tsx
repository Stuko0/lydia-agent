...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/lydia'
...
// / Program Files), which buried any files Lydia wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.lydiaDesktop` is
    ...
    const settings = window.lydiaDesktop?.settings
