import type { LydiaConfigRecord, ToolsetInfo } from '@/types/lydia'
...
export function getNested(obj: LydiaConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: LydiaConfigRecord, path: string, value: unknown): LydiaConfigRecord {
...
function personalityOptions(config: LydiaConfigRecord): string[] {
