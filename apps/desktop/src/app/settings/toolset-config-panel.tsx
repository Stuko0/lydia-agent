...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/lydia'
 ...
 * log inline — the GUI equivalent of the install step `lydia native` runs
