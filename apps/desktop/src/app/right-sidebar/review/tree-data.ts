...
export function buildReviewFlatList(files: LydiaReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: LydiaReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
