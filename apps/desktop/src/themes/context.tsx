...
const SKIN_KEY = 'lydia-desktop-theme-v2'
const MODE_KEY = 'lydia-desktop-mode-v1'
...
const PROFILE_SKINS_KEY = 'lydia-desktop-profile-themes-v1'
const PROFILE_MODES_KEY = 'lydia-desktop-profile-modes-v1'
// Last active profile, recorded so the boot-time paint can pick that profile's
// theme before the gateway reports which profile actually launched.
const LAST_PROFILE_KEY = 'lydia-desktop-active-profile-v1'
...
function applyTheme(theme: DesktopTheme, mode: 'light' | 'dark') {
  ...
  try {
    window.localStorage.setItem('lydia-boot-background', chromeBg)
    window.localStorage.setItem('lydia-boot-color-scheme', rendered)
  } catch {
...
/** Sync the desktop skin with the active Lydia backend theme on connect. */
