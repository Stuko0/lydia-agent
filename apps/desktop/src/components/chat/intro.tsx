...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Lydia look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Lydia need to see?`,
    ...
    {
      headline: `What should ${label} Lydia tackle?`,
  ...
  return (
    ...
    >
      <div className="w-full min-w-0">
        <p
          aria-label={WORDMARK}
          className="fit-text mx-auto mb-1 w-[calc(100%-1rem)] font-bold uppercase leading-[0.9] tracking-[0.04em] text-midground mix-blend-plus-lighter dark:text-foreground/90"
          style={{ fontFamily: "'Grenze Gotisch'", '--fit-min': '2.75rem' } as CSSProperties}
        >
          <span>
            <span>{WORDMARK}</span>
          </span>
