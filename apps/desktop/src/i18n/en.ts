...
export const en: Translations = {
  ...
  commandCenter: {
    ...
    generatePet: {
      ...
      staleBackend: 'Update Lydia to generate pets.',
      backgroundHint: 'You can close this — Lydia will notify you when it’s done.',
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Lydia inference gateway status',
      agents: 'Agents',
