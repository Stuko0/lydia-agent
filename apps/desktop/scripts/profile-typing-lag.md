...
cd apps/desktop
XCURSOR_SIZE=24 LYDIA_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/lydia-typing
# → /tmp/lydia-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/lydia-typing.before.heapsnapshot
# → /tmp/lydia-typing.after.heapsnapshot
```
