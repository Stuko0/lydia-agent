...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Lydia' : 'Setting up Lydia Agent'
  const description = isUpdate
    ? 'Lydia is updating to the latest version — this only takes a moment.'
  ...
  return (
    <div className="lydia-fade-in flex h-full flex-col">
