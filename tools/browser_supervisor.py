...
One ``CDPSupervisor`` runs per Lydia ``task_id`` that has a reachable CDP
...
DIALOG_BRIDGE_HOST = "lydia-dialog-bridge.invalid"
...
(() => {
  ...
  const ENDPOINT = "http://lydia-dialog-bridge.invalid/";
