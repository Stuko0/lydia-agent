...
Trust levels:
  - builtin:   Ships with Lydia. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.lydia/\.env|\~/\.lydia/\.env',
     "lydia_env_access", "critical", "exfiltration",
     "directly references Lydia secrets file"),
    ...
    (r'\.lydia/config\.yaml|\.lydia/SOUL\.md',
     "lydia_config_mod", "critical", "persistence",
     "references Lydia configuration files directly"),
...
# scan. `.skillignore` is the Lydia-native name; `.clawhubignore` is honored
