...
it is automatically downloaded from GitHub releases to $LYDIA_HOME/bin/tirith.
...
def _get_lydia_home() -> str:
    """Return the Lydia home directory, respecting LYDIA_HOME env var."""
    return str(get_lydia_home())
...
def _lydia_bin_dir() -> str:
    """Return $LYDIA_HOME/bin, creating it if needed."""
...
def _install_tirith(*, log_failures: bool = True) -> tuple[str | None, str]:
    """Download and install tirith to $LYDIA_HOME/bin/tirith.
...
def _resolve_tirith_path(configured_path: str) -> str:
    ...
    2. $LYDIA_HOME/bin/tirith (previously auto-installed)
    3. Auto-install from GitHub releases → $LYDIA_HOME/bin/tirith
