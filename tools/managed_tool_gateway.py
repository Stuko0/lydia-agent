...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "stuko.dev"
...
def auth_json_path():
    """Return the Lydia auth store path, respecting LYDIA_HOME overrides."""
    return get_lydia_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`lydia native`, banner/status paint, provider
