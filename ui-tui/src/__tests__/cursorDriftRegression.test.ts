 ...
 *
 * Symptom: in `lydia --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@lydia/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using lydia --tui and as i type multiline my caret at the end will often ' +
