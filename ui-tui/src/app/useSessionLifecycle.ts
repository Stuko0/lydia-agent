...
import type { ScrollBoxHandle } from '@lydia/ink'
import { evictInkCaches } from '@lydia/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.LYDIA_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
