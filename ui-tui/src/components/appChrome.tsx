import { Box, type ScrollBoxHandle, stringWidth, Text } from '@lydia/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (LYDIA_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (LYDIA_DEV_CREDITS), lowest priority,
