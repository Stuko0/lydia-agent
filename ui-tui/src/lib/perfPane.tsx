...
//
// Both gate on LYDIA_DEV_PERF=1 and dump JSON-lines (default ~/.lydia/perf.log,
...
import { scrollFastPathStats } from '@lydia/ink'
...
const LOG_PATH = process.env.LYDIA_DEV_PERF_LOG?.trim() || join(homedir(), '.lydia', 'perf.log')
