...
// Mirrors @lydia/ink's colorize.ts. Keep local: app code compiles from
// ui-tui/src, while @lydia/ink is bundled separately from packages/.
...
//
// Anything we can't decide stays dark — the default Lydia palette
// is the dark one.
