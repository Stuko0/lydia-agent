 ...
 * `window.__LYDIA_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Lydia brand in the top bar
 ...
 *  `window.__LYDIA_PLUGINS__.registerSlot(...)`.
 *
