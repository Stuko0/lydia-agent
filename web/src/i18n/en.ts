...
export const en: Translations = {
  ...
  status: {
    ...
    updateLydiaConfirmMessage:
      "This runs lydia update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateLydiaConfirmNow: "Update now",
    updateLydiaConfirmTitle: "Update Lydia?",
    updatingLydia: "Updating Lydia…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Lydia plugins (`lydia plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.lydia/plugins/?",
    removeHint: "Only user-installed plugins under ~/.lydia/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.lydia/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Lydia doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Lydia badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Lydia session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Lydia more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Lydia sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Lydia is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
