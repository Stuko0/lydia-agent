 ...
 *
 * Values mirror lydia_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Lydia default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Lydia' default when unset). */
