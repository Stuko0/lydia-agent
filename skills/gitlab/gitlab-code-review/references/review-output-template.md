...
Use this as the structure for MR review summary comments. Copy and fill in the sections.

## For MR Summary Comment
...
When reviewing locally before push, use the same structure but present it as a message to the user instead of an MR comment. Skip the MR metadata header and just start with the severity sections.
