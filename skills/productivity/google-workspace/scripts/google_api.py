#!/usr/bin/env python3
"""Google Workspace API CLI for Lydia Agent.

Uses the Google Workspace CLI (`gws`) when available, but preserves the
existing Lydia-facing JSON contract and falls back to the Python client
...
from _lydia_home import get_lydia_home
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for Lydia Agent")
