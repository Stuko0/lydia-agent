...
Built for [Lydia Agent](https://github.com/Stuko/lydia-agent). Usable in any coding agent. Canonical source lives here; synced to [`Stuko/lydia-agent/skills/creative/ascii-video`](https://github.com/Stuko/lydia-agent/tree/main/skills/creative/ascii-video) via PR.
