...
https://lydia-agent.stuko.dev/docs/user-guide/features/fallback-providers
...
def cmd_fallback_list(args) -> None:  # noqa: ARG001
    ...
    print("  Docs: https://lydia-agent.stuko.dev/docs/user-guide/features/fallback-providers")
    print()
