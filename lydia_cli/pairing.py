...
Usage:
    lydia pairing list              # Show all pending + approved users
    lydia pairing approve <platform> <code>  # Approve a pairing code
    lydia pairing revoke <platform> <user_id> # Revoke user access
    lydia pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle lydia pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: lydia pairing {list|approve|revoke|clear-pending}")
        print("Run 'lydia pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.lydia/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'lydia pairing list' to see pending codes.\n")
