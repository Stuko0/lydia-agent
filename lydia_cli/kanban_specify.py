...
Used by ``lydia kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``lydia_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Lydia Agent board.
...
def _profile_author() -> str:
    """Mirror of ``lydia_cli.kanban._profile_author``. Kept local to
