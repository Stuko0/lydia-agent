"""Client for uploading ``lydia debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``lydia debug share``.
...
NAS_BASE = os.environ.get(
    "LYDIA_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "lydia-agent/debug-share"
