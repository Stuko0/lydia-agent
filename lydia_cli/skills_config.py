"""
Skills configuration for Lydia Agent.
`lydia skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.lydia/config.yaml under:
...
from lydia_cli.config import cfg_get, load_config, save_config
from lydia_cli.colors import Colors, color
from lydia_cli.platforms import PLATFORMS as _PLATFORMS
