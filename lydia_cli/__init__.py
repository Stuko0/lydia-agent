"""
Lydia CLI - Unified command-line interface for Lydia Agent.

Provides subcommands for:
- lydia chat          - Interactive chat (same as ./lydia)
- lydia gateway       - Run gateway in foreground
- lydia gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `lydia setup` on a fresh Pi.
    ...
    lydia_cli/stdio.py::configure_windows_stdio() runs later from the entry
