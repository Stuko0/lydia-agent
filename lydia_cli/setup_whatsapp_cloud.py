...
Entry point: ``lydia whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``lydia_cli/main.py``).
...
Lydia gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Lydia to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Lydia needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Lydia gateway in another terminal:")
    print("         lydia gateway")
    print()
    ...
    print()
    print("  Docs: https://lydia-agent.nousresearch.com/docs/user-guide/")
