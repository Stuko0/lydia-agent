...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description=(
            "Launch the Lydia Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        "--ignore-existing",
        action="store_true",
        help="Force Desktop to ignore any lydia CLI already on PATH during backend resolution",
    )
    gui_parser.add_argument(
        "--lydia-root",
        help="Override the Lydia source root used by Desktop (sets LYDIA_DESKTOP_LYDIA_ROOT)",
    )
    gui_parser.add_argument(
        "--cwd",
