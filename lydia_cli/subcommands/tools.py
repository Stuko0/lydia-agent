"""``lydia native`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'lydia native' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # lydia native list [--platform cli]
    ...
    # lydia native disable <name...> [--platform cli]
    ...
    # lydia native enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `lydia native` runs after you pick a provider that\n"
