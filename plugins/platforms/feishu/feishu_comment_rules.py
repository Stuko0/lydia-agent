...
Config: ~/.lydia/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.lydia/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_lydia_home()`` helper (LYDIA_HOME-aware and
...
RULES_FILE = get_lydia_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_lydia_home() / "feishu_comment_pairing.json"
