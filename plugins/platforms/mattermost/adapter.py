...
required — uses aiohttp which is already a Lydia dependency.
...
def interactive_setup() -> None:
    ...
    ``lydia_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Lydia delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # lydia_cli/setup.py::_setup_mattermost function.
