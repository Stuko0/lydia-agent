...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Lydia gateway adapter.

    Each inbound phone number gets its own Lydia session (multi-tenant).
...
# static dict in lydia_cli/gateway.py, and the _send_sms dispatch in
