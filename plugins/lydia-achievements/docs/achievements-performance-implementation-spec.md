# Lydia Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.lydia/plugins/lydia-achievements/state.json` (existing unlock state)
  - `~/.lydia/plugins/lydia-achievements/scan_snapshot.json` (new)
  - `~/.lydia/plugins/lydia-achievements/scan_checkpoint.json` (new)
