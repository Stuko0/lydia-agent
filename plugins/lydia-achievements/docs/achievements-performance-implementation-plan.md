# Lydia Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.lydia/plugins/lydia-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.lydia/plugins/lydia-achievements/scan_checkpoint.json`.
