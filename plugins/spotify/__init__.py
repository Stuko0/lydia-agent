...
``_check_spotify_available()`` — when the user has not run ``lydia auth
spotify``, the tools remain registered (so they appear in ``lydia
...
The Spotify auth flow (``lydia auth spotify``), CLI plumbing, and docs
