#!/usr/bin/env python3
"""
SWE Runner with Lydia Trajectory Format

A runner that uses Lydia-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Lydia-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Lydia-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Lydia format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Lydia-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Lydia-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Lydia Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Lydia-Agent's built-in execution environments
    and outputs trajectories in Lydia-Agent format.
    """
    ...
    def _convert_to_lydia_format(
        ...
        """
        Convert internal message format to Lydia trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Lydia trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Lydia trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Lydia Trajectory Format")
    print("=" * 60)
