...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$LYDIA_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_lydia_dir("platforms/whatsapp/session", "whatsapp/session")
