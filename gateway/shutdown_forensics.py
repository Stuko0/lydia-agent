...
def check_systemd_timing_alignment(drain_timeout: float) -> Optional[Dict[str, Any]]:
    ...
    upgraded lydia-agent but never re-ran ``lydia setup`` to regenerate
    ...
    try:
        # /proc/self/cgroup gives us "0::/user.slice/.../lydia-gateway.service"
    ...
    # that's the common case for lydia.
    ...
    # constant in lydia_cli/gateway.py.
    headroom = 30.0
