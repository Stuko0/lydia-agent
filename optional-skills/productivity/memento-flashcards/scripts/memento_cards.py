...
Data file: $LYDIA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_LYDIA_HOME = Path(os.environ.get("LYDIA_HOME", Path.home() / ".lydia"))
DATA_DIR = _LYDIA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
